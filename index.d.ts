 ...
 */
export type Dropdown = (selector: string|JQuery, options?: DropdownOptions) => DropdownElement;
...
export type CallbackAutoComplete = () => string;
 ...
 * @param options
 */
export type AutoComplete = (element: string|JQuery, options?: AutoCompleteOptions) => any;
 ...
 * </table>
 */
export type DatePicker = (element: string|JQuery, options?: DatePickerOptions) => any;
 ...
 */
export type HtmlEditor = (element: string|JQuery, options?: HtmlEditorOptions) => any;
 ...
 * </table>
 */
export type Slider = (element: string|JQuery, options?: SliderOptions) => any;
export interface SlideSetOptions {
    /**
 ...
 * </table>
 */
export type SlideSet = (element: string|JQuery, options?: SlideSetOptions) => any;
 ...
 * </table>
 */
export type SlideShow = (element: string|JQuery, options: SlideShowOptions) => any;
 ...
 */
export type Parallax = (element: string|JQuery, options: ParallaxOptions) => any;
 ...
 * </table>
 */
export type Accordion = (element: string|JQuery, options: AccordionOptions) => any;
 ...
 */
export type Search = (element: string|JQuery, options: SearchOptions) => any;
 ...
 * </table>
 */
export type Nestable = (element: string|JQuery, options: NestableOptions) => any;
 ...
 * </table>
 */
export type Sortable = (element: string|JQuery, options: SortableOptions) => any;
 ...
 * </table>
 */
export type Sticky = (element: string|JQuery, options: StickyOptions) => any;
 ...
 */
export type Timepicker = (element: string|JQuery, options: TimepickerOptions) => any;
 ...
 */
export type Tooltip = (element: string|JQuery, options: TooltipOptions) => any;
export interface UploadOptions {
     ...
     */
        filelimit?: number;
    /**
     * Response export type from server
     * @default text
     * <h2>Possible Value</h2>
     * (text|json)
     */
 ...
 * </table>
 */
export type Upload = (element: string|JQuery, options: UploadOptions) => any;
...
export const htmleditor: HtmlEditor;
export const slider: Slider;
export const slideset: SlideSet;
...
export const uploadSelect: Upload;
export const uploadDrop: Upload;
